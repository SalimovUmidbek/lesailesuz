...
const Karzinka = () => {
    ...
    return (
        <div>
            ...
            <h2 className='text-3xl pt-[20px] border-b-2 w-28 mb-10 border-[#fc004a] pt-[10px]'>Savatcha</h2>
          ...
          {basket.map((item)=>(
              ...
              <li key={item.id} className="shadow-xl rounded-[15px] w-[281px] h-[431px]">
                  ...
                  <div className="flex justify-between items-center px-[15px] pt-[50px]">
                    ...
                    <button  onClick={()=>Remove(item.id)} className="w-[80px] h-[40px] bg-[#fc004a] rounded-[10px] text-white text-[20px] font-800">
                      remove
                    </button>
                  </div>
